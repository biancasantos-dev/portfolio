# Portfólio Profissional | Bianca Santos
...
<div align="center">
  ...
  <p align="center">
    Projetos digitais centrados na experiência do usuário, combinando padrões de arquitetura limpa e identidade visual autoral.
  </p>

  <p align="center">
    <a href="https://github.com/biancasantos-dev">
      <img src="https://img.shields.io/badge/GitHub-biancasantos--dev-181717?style=flat&logo=github" alt="GitHub">
    </a>
    <a href="https://www.linkedin.com/in/bianca-santos-408825123/">
      <img src="https://img.shields.io/badge/LinkedIn-Bianca%20Santos-0A66C2?style=flat&logo=linkedin" alt="LinkedIn">
    </a>
    <a href="mailto:biancasantos.dev@email.com">
      <img src="https://img.shields.io/badge/E--mail-Contato%20Profissional-D14836?style=flat&logo=gmail&logoColor=white" alt="E-mail">
    </a>
  </p>
...
- **Engenharia:** Controle de versão com Git/GitHub, Clean Code e semântica estrutural.
...
- **Validação de Formulário em Tempo Real:**
  Mecanismo client-side desenvolvido em JavaScript para validação instantânea dos campos (nome, e-mail, mensagem e termos de aceite), com retorno visual acessível e sanitização de dados de entrada.
...
portfolio/
├── assets/
│   ├── icones/               # Elementos gráficos e ícones em vetor SVG
│   ├── logos-projetos/        # Identidades visuais dos projetos integrados
│   └── ILUSTRA-PERFIL.svg    # Vetor de identificação visual
├── index.html                # Estrutura e semântica do documento
├── style.css                 # Folha de estilos, tokens e responsividade
├── script.js                 # Lógica de validações e comportamento interativo
...
Por utilizar exclusivamente tecnologias nativas, a aplicação não requer gerenciador de pacotes ou etapas de compilação.
...
3. Abra o arquivo `index.html` em qualquer navegador moderno, ou utilize a extensão Live Server em sua IDE.
